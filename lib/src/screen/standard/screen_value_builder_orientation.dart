...
/// Orientation-aware value selector using 5 breakpoints and portrait/landscape values.
class ScreenValueBuilderOrientation<K, V extends Object?>
    extends StatefulWidget {
  /// Creates an orientation-aware value selector for the current media query orientation.
