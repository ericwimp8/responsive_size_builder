...
/// Resolves a value from granular screen size and orientation.
class ScreenValueBuilderGranularOrientation<K, V extends Object?>
    extends StatefulWidget {
  /// Creates a granular screen-value builder with portrait or landscape values.
  ...
  /// Builds the widget for the selected granular value.
  ...
  /// The breakpoints used to resolve granular screen sizes.
