...
/// Chooses a widget builder from `MediaQuery` using granular breakpoints.
class ScreenWidgetBuilderGranular extends StatefulWidget
    with AnimatedChildMixin {
  /// Creates a granular screen widget builder.
  ...
  /// Breakpoints used to pick the matching builder.
...
class _ScreenWidgetBuilderGranularState
  ...
  late BreakpointsHandlerGranular<ScreenWidgetBuilderFn<LayoutSizeGranular>>
  ...
  @override
  void didUpdateWidget(ScreenWidgetBuilderGranular oldWidget) {
