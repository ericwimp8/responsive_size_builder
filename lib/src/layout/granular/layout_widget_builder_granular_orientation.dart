...
/// Builds a granular layout widget from portrait and landscape callbacks.
class LayoutWidgetBuilderGranularOrientation extends StatefulWidget
    with AnimatedChildMixin {
  /// Creates an orientation-aware granular layout builder.
  ...
  /// Breakpoints used to resolve the active granular size.
  final BreakpointsGranular breakpoints;

  /// Whether layout resolution should use the shortest side.
