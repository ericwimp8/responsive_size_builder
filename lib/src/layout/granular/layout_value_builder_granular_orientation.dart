...
/// of type [K] from local [LayoutBuilder] constraints using the 12
/// [LayoutSizeGranular] breakpoints.
class LayoutValueBuilderGranularOrientation<K> extends StatefulWidget {
  /// Creates an orientation-aware granular layout value selector.
  const LayoutValueBuilderGranularOrientation({
  ...
  @override
  State<LayoutValueBuilderGranularOrientation<K>> createState() =>
      _LayoutValueBuilderGranularOrientationState<K>();
}

class _LayoutValueBuilderGranularOrientationState<K>
    extends State<LayoutValueBuilderGranularOrientation<K>> {
