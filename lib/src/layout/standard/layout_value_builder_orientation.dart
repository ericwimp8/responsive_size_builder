...
/// Use the base fields for portrait values and the `*Landscape` fields for
/// landscape values.
class LayoutValueBuilderOrientation<K> extends StatefulWidget {
  /// Creates an orientation-aware value selector with optional portrait and
  /// landscape breakpoint values.
