...
/// Builds a widget for the current granular screen size and passes the
/// responsive value to it.
class ScreenWithValueWidgetBuilderGranular<V extends Object?>
    extends StatefulWidget with AnimatedChildMixin {
  /// Creates a granular screen-size-aware builder with optional breakpoint
  /// callbacks.
