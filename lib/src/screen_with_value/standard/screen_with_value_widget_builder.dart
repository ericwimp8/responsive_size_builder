...
/// Builds a widget for the current screen size and passes the responsive value to it.
class ScreenWithValueWidgetBuilder<V extends Object?> extends StatefulWidget
    with AnimatedChildMixin {
  /// Creates a screen-size-aware builder with optional breakpoint callbacks.
