...
void main() {
  group('ScreenWithValueWidgetBuilderOrientation', () {
    test('requires at least one portrait or landscape builder', () {
      expect(
        ScreenWithValueWidgetBuilderOrientation<String>.new,
    ...
    testWidgets('uses portrait builders when orientation is portrait', (
      ...
      await pumpHarnessApp(
        ...
        child: ScreenSizeWithValue<LayoutSize, String>(
          ...
          child: ScreenWithValueWidgetBuilderOrientation<String>(
            medium: (_, __) => const SizedBox(key: Key('portrait')),
            mediumLandscape: (_, __) => const SizedBox(key: Key('landscape')),
          ),
        ),
      );
    ...
    testWidgets('uses landscape builders when orientation is landscape', (
      ...
      await pumpHarnessApp(
        ...
        child: ScreenSizeWithValue<LayoutSize, String>(
          ...
          child: ScreenWithValueWidgetBuilderOrientation<String>(
            large: (_, __) => const SizedBox(key: Key('portrait')),
            largeLandscape: (_, __) => const SizedBox(key: Key('landscape')),
          ),
        ),
      );
